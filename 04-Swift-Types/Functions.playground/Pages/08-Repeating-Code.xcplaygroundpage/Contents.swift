 ...
 */
func drawTriangle(steps: Int, angle: Int) {
    for _ in 1...3 {
        move(steps: steps)
        rotate(degrees: angle)
    }
}
drawTriangle(steps: 50, angle: 120)

func drawSquare(steps:Int, angle: Int) {
    for _ in 1...4 {
        move(steps: steps)
        rotate(degrees: angle)
    }
}
drawSquare(steps: 60, angle: 90)

func drawPentagon(steps: Int, angle: Int) {
    for _ in 1...5 {
        move(steps: steps)
        rotate(degrees: angle)
    }
}
drawPentagon(steps: 70, angle: 72)
