...
var maybePerson1: Person? = Person(name: "Uchenna")
var maybePerson2: Person? = nil

func myNameIs(person: Person?) -> String {
    if let thisPerson = person {
        return "My name is \(thisPerson)"
    } else {
...
func myNameIs2(person: Person?) -> String {
    switch person {
    case let a?: return "My name is \(a)."
    case nil: return "This is not a valid person object."
    }
}
